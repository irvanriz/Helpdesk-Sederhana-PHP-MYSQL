	...
	<div class="container">
		<div class="content">
			...
			<a href="tambah_kategori.php">
                    <button type="button" class="btn btn-primary" name=""> <i class="fa fa-trash"></i> Tambah Kategori</button></a>
            <hr />
			...
			?>
				<tr>
					...
					<td>
                    <a onclick="return confirm('Anda Yakin Menghapus Data Ini?')" href="aksi/delete_kategori.php?id=<?php echo $mas['id'] ?>">
